...
export const ANDAMAN_PRICE_MULTIPLIER = 1.5;

export const applyAndamanPrice = (amount: number) =>
  Math.round(amount * ANDAMAN_PRICE_MULTIPLIER);
...
export function buildPricingMap(nightsCount: number, starRating: 2 | 3 | 4 | 5, planType: "CP" | "MAP" = "CP"): Record<number | string, { selectedHotelCost: number; carCost: number; shipCost: number; ticketsCost: number; serviceCharge: number; totalPrice: number; perPersonPrice: number }> {
  ...
  paxList.forEach(pax => {
    ...
    const baseTotal = planType === "MAP" ? cpTotal + (pax * nightsCount * mapSurplusPerPaxPerNight) : cpTotal;
    const total = applyAndamanPrice(baseTotal);
...
export const ANDAMAN_PACKAGES: AndamanPackage[] = [
  ...
  // =========================================================================
  {
    ...
    subtitle: "3 Days / 2 Nights • Port Blair, Ross & North Bay",
  ...
  },
  {
    ...
    subtitle: "4 Days / 3 Nights • Port Blair & Havelock Island",
  ...
  },
  {
    ...
    subtitle: "5 Days / 4 Nights • Port Blair, Havelock & Neil Island",
...

  {
    ...
    subtitle: "6 Days / 5 Nights • Port Blair, Havelock & Neil",
  ...
  },
  {
    ...
    subtitle: "7 Days / 6 Nights • Port Blair, Baratang, Havelock & Neil",
  ...
  },
  {
    ...
    subtitle: "8 Days / 7 Nights • Complete 4-Island Route",
  ...
  },
  {
    ...
    subtitle: "9 Days / 8 Nights • Neil Island Sunrise Special",
  ...
  },
  {
    ...
    subtitle: "10 Days / 9 Nights • Diglipur & Pristine Beach Special",
  ...
  },
  {
    ...
    subtitle: "11 Days / 10 Nights • Ultimate Island Expedition",
