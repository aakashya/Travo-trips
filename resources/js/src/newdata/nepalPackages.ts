...
export const NEPAL_PACKAGES: NepalPackage[] = [
  // 1. Temple Valley Kathmandu 2N/3D
  {
    ...
    subtitle: "2 Nights / 3 Days • Pashupatinath, Boudhanath, Swayambhunath & Kathmandu Durbar Square",
  ...
  // 2. Kathmandu on Top & Chandragiri 3N/4D
  {
    ...
    subtitle: "3 Nights / 4 Days • Kathmandu Heritage, Jal Narayan & Chandragiri Hill Cable Car",
  ...
  // 3. Kathmandu & Nagarkot Everest Sunrise 4N/5D
  {
    ...
    subtitle: "4 Nights / 5 Days • Bhaktapur, Changu Narayan UNESCO Temple, Nagarkot Panoramic Peaks & Patan",
  ...
  // 4. Nepal Twin Valley: Kathmandu & Pokhara 4N/5D
  {
    ...
    subtitle: "4 Nights / 5 Days • Kathmandu Temples, Manakamana Cable Car, Peace Stupa & Phewa Lake",
    duration: "5 Days / 4 Nights",
    daysCount: 5,
    nightsCount: 4,
  ...
  // 5. Nepal Twin Valley Grand: Kathmandu & Pokhara 5N/6D
  {
    ...
    subtitle: "5 Nights / 6 Days • Patan Durbar Square, Sarangkot Sunrise, Phewa Lake & Flight Return to KTM",
  ...
  // 6. Nepal Wildlife & Heritage: Kathmandu & Chitwan 4N/5D
  {
    ...
    subtitle: "4 Nights / 5 Days • Pashupatinath, Boudhanath, Chitwan Jungle Safari, Rapti Canoe & Manakamana",
    duration: "5 Days / 4 Nights",
    daysCount: 5,
    nightsCount: 4,
  ...
  // 7. Nepal Golden Triangle: Kathmandu, Pokhara & Chitwan 6N/7D
  {
    ...
    subtitle: "6 Nights / 7 Days • Annapurna Sunrise, World Peace Stupa, Chitwan Safari & Manakamana",
  ...
  // 8. Nepal Grand Explorer: Kathmandu, Nagarkot, Pokhara & Chitwan 7N/8D
  {
    ...
    subtitle: "7 Nights / 8 Days • Nagarkot Everest Sunrise, Bhaktapur UNESCO, Sarangkot & Chitwan Safari",
  ...
  // 9. Nepal Mystical Muktinath & Jomsom Pilgrimage 6N/7D
  {
    ...
    subtitle: "6 Nights / 7 Days • Sacred Muktinath Temple 108 Sprouts, Pokhara & Kathmandu Valley",
    duration: "7 Days / 6 Nights",
    daysCount: 7,
    nightsCount: 6,
