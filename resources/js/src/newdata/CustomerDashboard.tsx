...
import { 
  ...
  MessageSquare, Plane, Ticket, CreditCard, Coins, Copy, CheckCircle, Clock
} from "lucide-react";
...
export default function CustomerDashboard({ onNavigate, onOpenBooking, initialTab = "bookings" }: CustomerDashboardProps) {
  ...
  const [editDiet, setEditDiet] = useState(user?.dietaryPreference || "Vegetarian");
  ...
  // Referral copied & claiming state
  const [referralCopied, setReferralCopied] = useState(false);
  const [inputReferralCode, setInputReferralCode] = useState("");
  const [referralFeedback, setReferralFeedback] = useState<{ text: string; type: "success" | "error" } | null>(null);
  ...
  if (!isLoggedIn || !user) {
    return (
      <div className="min-h-screen bg-[#FAF9F6] text-neutral-900 text-left flex flex-col justify-between">
        <WebsiteHeader currentView="customer-dashboard" onNavigate={onNavigate} />
  ...
  const handleClaimReferral = (e: React.FormEvent) => {
    ...
    const res = claimReferralBonus(inputReferralCode);
    if (res.success) {
      setReferralFeedback({ text: res.message, type: "success" });
      setInputReferralCode("");
    } else {
      setReferralFeedback({ text: res.message, type: "error" });
    }
  ...
  return (
    <div className="min-h-screen bg-[#FAF9F6] text-neutral-900 pb-28 text-left">
      ...
      {/* 1. TOP CUSTOMER HERO & TRAVELER IDENTITY BANNER */}
      <div className="bg-gradient-to-b from-neutral-950 via-neutral-900 to-neutral-950 text-white relative overflow-hidden border-b border-neutral-800">
            ...
            <div className="flex items-center gap-4 sm:gap-5">
              <div className="relative">
                {user.avatar ? (
                  <img 
                    src={user.avatar} 
                    alt={user.name} 
                    className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl object-cover border-2 border-[#D4AF37] shadow-xl"
                  />
                ) : (
                  <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-gradient-to-br from-[#9C753B] to-[#D4AF37] text-neutral-950 font-black text-2xl flex items-center justify-center border-2 border-white/20 shadow-xl">
                    {user.name.charAt(0)}
                  </div>
                )}
              ...
              <div className="space-y-1">
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <span className="px-2.5 py-0.5 bg-gradient-to-r from-[#9C753B] to-[#D4AF37] text-neutral-950 font-black text-[10px] uppercase rounded-full tracking-wider shadow-xs">
                    {user.membershipTier}
                  </span>
                  <span className="px-2 py-0.5 bg-white/10 text-neutral-300 font-mono text-[10px] rounded-full">
                    ID: TRAVO-{user.phone.slice(-4) || '8821'}
                  </span>
                </div>
                ...
                <p className="text-[11px] text-neutral-400 font-light">
                  Travel Club Member since {user.joinedDate} • {bookings.length} Journeys Booked
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              >
                <p className="text-[10px] uppercase font-mono text-amber-300 font-bold flex items-center gap-1">
                  <Coins className="w-3.5 h-3.5 text-amber-400" /> Travo Coins
                </p>
                <p className="text-base sm:text-lg font-black text-amber-400 flex items-center gap-1.5">
                  <span>{userCoins.toLocaleString("en-IN")}</span>
                  <span className="text-xs font-normal text-neutral-300">(= ₹{userCoins.toLocaleString("en-IN")})</span>
                </p>
              </button>
              ...
              >
                <p className="text-[10px] uppercase font-mono text-neutral-400 font-bold flex items-center gap-1">
                  <QrCode className="w-3.5 h-3.5 text-emerald-400" /> Travel ID
                </p>
                <p className="text-base sm:text-lg font-black text-emerald-400">
                  Verified <span className="text-xs font-normal text-neutral-400">Pass</span>
                </p>
              </button>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center space-x-1 sm:space-x-4 overflow-x-auto py-2.5 no-scrollbar">
            ...
            >
              ...
              <span className="px-1.5 py-0.2 rounded-full text-[10px] font-black bg-amber-400 text-neutral-950">
                {userCoins}
              </span>
            </button>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                        ...
                        <div className="lg:col-span-4 relative min-h-[200px] lg:min-h-full">
                          ...
                          <div className="absolute top-3 left-3 right-3 flex items-center justify-between gap-2">
                            ...
                            <span className={`px-2.5 py-1 text-[10px] font-black uppercase rounded-full shadow ${
                              ...
                              {b.status === "confirmed" ? "✓ Confirmed & Vouched" : b.status}
                            </span>
                          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
                <div className="md:col-span-2 space-y-4">
                  ...
                  <h3 className="text-2xl sm:text-3xl font-black font-display uppercase tracking-tight text-white flex items-center gap-3">
                    <span>{user.membershipTier} Voyager</span>
                  </h3>
                  <p className="text-xs text-neutral-300 max-w-lg leading-relaxed font-light">
                    Every trip you book earns you instant Travo Coins that can be redeemed 1:1 against any future road trip, island escape, or mountain tour!
                  </p>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2">
                    ...
                    <div className="bg-white/10 rounded-2xl p-3 border border-white/10">
                      ...
                      <p className="text-[10px] text-neutral-400">5% effective cashback</p>
                    </div>
                    <div className="bg-white/10 rounded-2xl p-3 border border-white/10">
                ...
                <div className="bg-black/40 backdrop-blur-md rounded-2xl p-5 border border-white/10 flex flex-col justify-between space-y-4">
                  <div>
                    <p className="text-[10px] font-mono uppercase font-bold text-neutral-400 flex items-center gap-1.5">
                      <Coins className="w-3.5 h-3.5 text-amber-400" /> Current Coin Balance
                    </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-3xl p-6 border border-neutral-200 shadow-xs space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="text-base font-black uppercase text-neutral-900">Have a Friend's Code?</h4>
                    <p className="text-xs text-neutral-500">Enter their referral code to receive <strong>300 instant Travo Coins</strong> into your account right now.</p>
                  </div>
                </div>
                ...
                <form onSubmit={handleClaimReferral} className="space-y-2">
                  <div className="flex gap-2">
                    <input
                      ...
                      placeholder="e.g. ROHAN300"
                      className="flex-1 px-3.5 py-2 text-xs bg-neutral-50 border border-neutral-300 rounded-xl focus:bg-white focus:border-[#9C753B] outline-hidden font-mono uppercase"
                    />
                    <button
                      type="submit"
                      className="px-4 py-2 bg-neutral-900 hover:bg-neutral-800 text-white text-xs font-bold rounded-xl transition-all uppercase tracking-wider shrink-0"
                    >
                      Claim 300 Coins
                    </button>
                  </div>
                  ...
                  {referralFeedback && (
                    <p className={`text-xs font-medium ${referralFeedback.type === "success" ? "text-emerald-700" : "text-rose-600"}`}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs text-neutral-700">
                <div className="p-4 bg-neutral-50 rounded-2xl space-y-2 border border-neutral-100">
                  ...
                  <p className="text-neutral-600 leading-relaxed">
                    For every ₹100 you spend on any B2B tour package, Kashmir package, Leh Ladakh package, or Andaman trip, you automatically earn <strong>5 Travo Coins</strong>.
                  </p>
                </div>
        ...
        {activeTab === "profile" && (
          <div className="space-y-8">
            ...
            {/* 1. DIGITAL TRAVEL ID PASS CARD (METALLIC LUXURY EMBLEM) */}
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-neutral-950 via-neutral-900 to-neutral-950 p-6 sm:p-8 text-white border border-[#D4AF37]/30 shadow-2xl">
              {/* Background Glow & Pattern */}
              <div className="absolute top-0 right-0 w-80 h-80 bg-gradient-to-br from-[#9C753B]/20 to-amber-500/10 rounded-full blur-3xl pointer-events-none" />
              <div className="absolute -bottom-10 -left-10 w-64 h-64 bg-[#D4AF37]/10 rounded-full blur-2xl pointer-events-none" />
              ...
              <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 pb-6 border-b border-white/10">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-[#9C753B] to-[#D4AF37] text-neutral-950 flex items-center justify-center font-black shadow-lg">
                    <Compass className="w-7 h-7" />
                  </div>
                  <div>
                    <span className="text-[10px] font-mono tracking-widest uppercase text-amber-300 font-bold block">
                      OFFICIAL EXPEDITION PASS
                    </span>
                    <h3 className="text-xl sm:text-2xl font-black font-display tracking-tight text-white uppercase">
                      TRAVO DIGITAL TRAVEL ID
                    </h3>
                  </div>
                </div>

                <div className="flex items-center gap-2">
                  <span className="px-3 py-1 bg-gradient-to-r from-[#9C753B] to-[#D4AF37] text-neutral-950 text-xs font-black uppercase tracking-wider rounded-full shadow-md">
                    {user.membershipTier}
                  </span>
              ...
              <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-6 pt-6 items-center">
                ...
                <div className="flex items-center gap-4 md:col-span-2">
                  <div className="relative">
                    {user.avatar ? (
                      ...
                      <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-2xl bg-gradient-to-br from-[#9C753B] to-[#D4AF37] text-neutral-950 font-black text-3xl flex items-center justify-center border-2 border-white/20 shadow-xl">
                        {user.name.charAt(0)}
                      </div>
                    )}
                    <div className="absolute -bottom-2 -right-2 p-1 bg-amber-400 text-neutral-950 rounded-full border-2 border-neutral-900 shadow-md" title="Gold Level Pass">
                      <Sparkles className="w-3.5 h-3.5" />
                    </div>
                  </div>

                  <div className="space-y-1">
                    <p className="text-[10px] font-mono uppercase tracking-widest text-neutral-400">Cardholder Name</p>
                    <h4 className="text-xl sm:text-2xl font-black text-white font-display uppercase tracking-tight">{user.name}</h4>
                    <p className="text-xs font-mono text-amber-300 font-bold">
                      TRAVEL ID: TRAVO-TRV-{(user.phone || "8821").slice(-4)}-{user.name.slice(0, 3).toUpperCase()}
                    </p>
                ...
                <div className="flex flex-col sm:flex-row md:flex-col items-center justify-center p-4 bg-white/5 border border-white/10 rounded-2xl backdrop-blur-md text-center gap-3">
                  ...
                  <div>
                    ...
                    <span className="text-[11px] text-neutral-400">
                      Instant Check-in & Permit Verification
                    </span>
                  </div>
                </div>
              ...
              {/* Footer Metadata */}
              <div className="relative z-10 mt-6 pt-4 border-t border-white/10 flex flex-wrap items-center justify-between gap-4 text-xs text-neutral-400">
                <div className="flex flex-wrap items-center gap-4">
                  <div>
                    <span className="text-[10px] font-mono text-neutral-500 block uppercase">Home City</span>
                    <span className="text-white font-bold">{user.city || "Bengaluru, India"}</span>
                  </div>
                  <div>
                    <span className="text-[10px] font-mono text-neutral-500 block uppercase">Dietary</span>
                    <span className="text-amber-300 font-bold">{user.dietaryPreference || "Vegetarian"}</span>
                  </div>
                  <div>
                    <span className="text-[10px] font-mono text-neutral-500 block uppercase">Travo Coins</span>
                    <span className="text-amber-400 font-mono font-black">{userCoins.toLocaleString("en-IN")}</span>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    <Printer className="w-3.5 h-3.5 text-[#D4AF37]" /> Print Card
                  </button>
                  <button
                    onClick={() => setIsEditingProfile(true)}
                    className="px-3.5 py-1.5 bg-[#9C753B] hover:bg-[#85632f] text-white rounded-xl text-xs font-bold flex items-center gap-1.5 transition-colors shadow-xs"
                  >
              ...
              {isEditingProfile ? (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-xs">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="font-bold text-neutral-900">{user.city || "Bengaluru, Karnataka"}</p>
                  </div>

                  <div className="space-y-1">
                    <p className="text-[10px] font-mono uppercase font-bold text-neutral-400">Dietary Preference</p>
                    <p className="font-bold text-emerald-700">{user.dietaryPreference || "Vegetarian"}</p>
                  </div>
            ...
            <div className="bg-white rounded-3xl p-6 sm:p-8 border border-neutral-200 shadow-xs space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="p-6 bg-neutral-50 rounded-3xl border border-neutral-200 space-y-4">
                  ...
                  <a
                    href="mailto:support@travoexpeditions.com"
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/75 backdrop-blur-md">
            ...
            >
              <div className="flex items-center gap-3 text-red-600">
                ...
                <div>
                  <h4 className="text-base font-black uppercase text-neutral-900">Cancel or Reschedule Booking</h4>
                  <p className="text-xs text-neutral-500">100% refund as Travo Coins credit</p>
                </div>
              </div>
              ...
              <div className="p-3 bg-neutral-100 rounded-xl text-[11px] text-neutral-600">
                💡 <em>Tip: As a Gold Explorer member, you can also reschedule your trip dates for free without any penalty!</em>
              </div>
