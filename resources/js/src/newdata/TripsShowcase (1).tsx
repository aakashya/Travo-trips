...
import { 
  ...
  TrendingUp, CheckCircle2, Award, ArrowUpRight, Heart
} from "lucide-react";
...
function getTripVibe(tripId: string): string {
  ...
  if (tripId === "udaipur") return "Royal Heritage";
...
export default function TripsShowcase({ onNavigate, onOpenBooking }: TripsShowcaseProps) {
  ...
  const visibleCities = useMemo(() => {
    if (selectedCountry === "all") return CITIES_DATA;
    return CITIES_DATA.filter((city) => city.country === selectedCountry);
  }, [selectedCountry]);
  ...
  const filteredAndSortedTrips = useMemo(() => {
    let result = TRIPS_LIST.filter((trip) => {
      ...
      if (vibeFilter !== "all") {
        ...
        if (vibeFilter === "roadtrips" && trip.id !== "manali" && trip.id !== "valley-of-flowers" && trip.id !== "udaipur") return false;
        if (vibeFilter === "heritage" && trip.id !== "udaipur" && !trip.id.startsWith("bhutan-") && !trip.id.includes("heritage")) return false;
      }
    ...
    <section id="trips-catalog-view" className="py-8 sm:py-12 px-4 sm:px-6 bg-[#FAF9F6] text-neutral-900 relative">
      <div className="max-w-7xl mx-auto space-y-8 sm:space-y-10">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
              {[
                ...
                { 
                  ...
                  desc: "Kerala, Andaman, Sikkim, Goa, Manali, VOF" 
                },
                { 
                  id: "bhutan", 
                  ...
                  desc: "Fixed Departures & SDF Included" 
                },
                { 
                  id: "nepal", 
                  ...
                  desc: "Kathmandu, Pokhara & Chitwan" 
                }
              ].map((c) => {
                  ...
                  >
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        ...
                        <p className={`text-[10px] line-clamp-1 font-light ${isActive ? "text-amber-100" : "text-neutral-500"}`}>
                          {c.desc}
                        </p>
                      </div>
                    </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
            ...
            {selectedCityId && (
              <button
                ...
                className="self-start sm:self-auto px-3 py-1 bg-neutral-200 hover:bg-neutral-300 text-neutral-800 rounded-full text-xs font-bold flex items-center gap-1.5 transition-all"
              >
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 py-2 border-b border-neutral-200">
          ...
          {/* Left: Summary text and active filters */}
          ...
          {/* Right: Quick Sort Indicator */}
          <div className="text-[11px] text-neutral-500 font-medium">
            Verified private AC transfers & MMT rated hotels
          </div>
        </div>
                    ...
                    <div className="relative h-64 overflow-hidden">
                      ...
                      <div className="absolute top-3.5 left-3.5 z-10">
                        <span className="px-3 py-1 bg-black/65 backdrop-blur-md text-white text-[10px] font-black uppercase tracking-wider rounded-full border border-white/15 shadow-sm flex items-center gap-1.5">
                          ...
                          <span className="text-amber-200">{vibe}</span>
                        </span>
                      </div>
                    ...
                    <div className="p-5 sm:p-6 space-y-4">
                      ...
                      <div className="grid grid-cols-3 gap-2 pt-1 border-t border-neutral-100 text-[10px] text-neutral-600">
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <span className="truncate">MAP Meals</span>
                        </div>
                      </div>
            ...
            {filteredAndSortedTrips.map((trip) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="relative w-full md:w-64 md:shrink-0 h-48 md:h-auto rounded-2xl overflow-hidden">
                    <img 
                      src={trip.bannerImage || trip.heroImage} 
                      alt={trip.name} 
                      className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"
                  ...
                  <div className="flex-1 flex flex-col justify-between space-y-3">
                    ...
                    <div className="flex items-center gap-4 text-[11px] text-neutral-600 pt-2 border-t border-neutral-100">
                      ...
                      <span className="flex items-center gap-1"><Utensils className="w-3 h-3 text-[#9C753B]" /> MAP Breakfast & Dinner</span>
                    </div>
                  </div>
        ...
        <div className="p-8 sm:p-10 bg-neutral-900 text-white rounded-3xl flex flex-col lg:flex-row items-center justify-between gap-8 relative overflow-hidden shadow-xl">
          ...
          <div className="relative z-10 flex flex-col sm:flex-row items-center gap-3 shrink-0 w-full lg:w-auto">
            <button 
              onClick={() => onOpenBooking("custom-inquiry")}
      ...
      {/* ========================================================================= */}
      {quickViewTrip && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-xs animate-[fadeIn_0.2s_ease-out]">
          <div className="bg-white rounded-3xl max-w-2xl w-full max-h-[90vh] overflow-y-auto border border-neutral-200 shadow-2xl p-6 sm:p-8 space-y-6 relative">
